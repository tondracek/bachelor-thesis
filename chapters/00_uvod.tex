...
V~posledních letech roste zájem zákazníků o~nákup potravin a výrobků od menších producentů, lokálních farem nebo domácích pěstitelů~\parencite{lokalni_potraviny_zajem, szif_2025}.
...
% TODO: Uvést zdroj nebo důkaz, že dostupné nástroje skutečně nejsou zaměřeny na jednoduchou a samostatnou propagaci drobných/domácích producentů.
...
Takovéto metody mohou mít omezený dosah.
Producentům i zákazníkům by přitom mohl pomoci nástroj, který umožní přehlednější a dostupnější prezentaci nabídky.

Cílem této práce je navrhnout a implementovat aplikaci pro platformu Android, která řeší uvedenou problematiku.
