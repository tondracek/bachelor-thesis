...
Velmi přínosným prvkem se ukázalo zavedení vlastního typu pro reprezentaci výsledků operací, inspirovaného monadickým přístupem, který umožnil elegantní a robustní řešení chyb.
...
Aplikace byla následně otestována pomocí jednotkových testů, manuálního testování i testování na uživatelích, na jejichž základě došlo k~dalším úpravám a zlepšení použitelnosti.
