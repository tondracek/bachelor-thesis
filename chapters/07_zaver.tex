...
V~rámci práce byla nejprve provedena analýza existujících řešení a identifikace jejich nedostatků v~oblasti podpory drobných producentů.
Na základě této analýzy byl vytvořen návrh aplikace využívající standardní techniky softwarového inženýrství.

Následně byla navržena architektura aplikace, kde byl kladen důraz zejména na oddělení jednotlivých vrstev aplikace, přehlednost kódu a jeho dlouhodobou udržovatelnost.
