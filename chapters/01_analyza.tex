...
\begin{table}[htbp]
    ...
    & \cmark & \cmark & \xmark & \cmark & \xmark \\

    Zprostředkování přímého prodeje
    & \xmark & \cmark & \pmark\tnote{c} & \xmark & \xmark \\
    ...
    \bottomrule
        ...
        \begin{tablenotes}
            \footnotesize
            \item[a] Registrace je možná pouze po schválení provozovatelem projektu.
            \item[b] Vstup do platformy podléhá kontrolnímu procesu a výběru producentů.
            \item[c] Prodej probíhá formou jednotlivých inzerátů, nikoliv systematického tržiště.
        \end{tablenotes}
