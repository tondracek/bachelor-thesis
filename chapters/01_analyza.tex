...
Takovýto producenti často nemají vlastní webové stránky a nechtějí řešit složité registrační či schvalovací procesy.
Navrhovaná aplikace by však poskytovala jednoduchý způsob, jak být dohledatelní pro zákazníky v~okolí.
...
\begin{itemize}
    \item Zákazník otevře aplikaci z domu nebo na cestě, zobrazí mapu okolí a vyfiltruje kategorie a vzdálenost a následně kontaktuje producenta, který nabízí požadované produkty.
    \item Producent vytvoří obchod, přidá nabízené produkty, kontaktní informace a přidá fotografie produktů a místa prodeje
\end{itemize}
