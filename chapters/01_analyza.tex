...
%Citaci by se hodilo dat do seznamu literatury a zde mit klasicky odkaz.
...
Druhou možností je lokální propagace prostřednictvím cedulí, osobního doporučení nebo příspěvků na sociálních sítích, která však bývá omezená svým dosahem.

Typickým využitím aplikace může být:
%Pozor na sirotky/vdovy
\begin{itemize}
...
%Hodilo by se dat i odkazy, odkud jsou aplikace dostupne. Idealne hned na zacatek kapitoly na az na konec 2. odstavce formou poznamky pod carou.

\subsection[Farmáři z~regionu]{Farmáři z~regionu}
Farmáři z~regionu je mapová aplikace, která sdružuje lokální farmáře a poskytuje informační katalog jejich produktů a provozoven~\parencite{metropolitni_brno_farmari_2025}.
...
\subsection{Scuk.cz}
%Opet by se hodilo dat odkaz do seznamu literatury, kde by byl link, ne pouze formou poznamek pod carou.
Scuk.cz je česká online platforma zaměřená na podporu lokálních farmářů a malých až středních producentů potravin~\parencite{scuk_napoveda_2025}.
...
%Odkaz/citace na facebook je kde?
...
%Kde roste Facebook Market Place
