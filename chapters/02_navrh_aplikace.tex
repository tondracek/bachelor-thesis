...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Systém umožňuje registrovanému uživateli přidávat a upravovat u~svých obchodů název, popis, kategorie produktů, fotografie, nabídku produktů a otevírací dobu.
    \end{itemize}
...
Cena je reprezentována hodnotovým objektem \texttt{Price\-Label}, který uchovává cenu jako formátovaný řetězec.
