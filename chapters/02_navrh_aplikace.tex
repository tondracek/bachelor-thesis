...
Webová aplikace by sice zajistila širší dostupnost napříč zařízeními, avšak v~prostředí mobilních zařízení by ve srovnání s~nativní mobilní aplikací poskytovala méně vhodný uživatelský zážitek, jak z~hlediska výkonu a odezvy, tak i z~hlediska přístupu k~nativním funkcím zařízení.\footfullcite{native_vs_web_app}

Další možností by bylo využití multiplatformních frameworků, jako jsou Flutter nebo React Native.
Tato řešení však přidávají další vrstvu abstrakce a mohou zvyšovat složitost integrace s~nativními funkcemi zařízení, jako jsou práce s~mapami, polohou uživatele nebo fotoaparátem.\footfullcite{native_vs_cross_platform}
...
V~České republice je navíc právě Android nejrozšířenějším operačním systémem pro mobilní zařízení, a proto je tato platforma vhodnou volbou pro tuto aplikaci.\footfullcite{android_market_share_cz}
...
Pro mobilní aplikaci pro platformu Android se v~praxi využívají většinou dvě hlavní možnosti: Material Design 3 nebo vlastní designový systém.\footfullcite{android_design_system_options}
...
Použití vlastního designového systému je vhodné řešení především pro velké společnosti, které chtějí, aby jejich aplikace vzhledově a stylově odpovídala značce produktu či společnosti.\footfullcite{custom_design_system_benefits}

Další možností pro Android aplikace je využití Material Designu, což je designový systém vyvinutý společností Google.
Pro vývoj nových aplikací je doporučováno využití nejnovější verze Material Design 3, která přináší moderní vzhled, lepší podporu pro tmavý režim a vestavěné komponenty a vzory pro lepší uživatelský zážitek.\footfullcite{material_design_3_recommendation}
...
Zvolené řešení Firebase představuje plnohodnotné backendové řešení typu \textbf{Backend-as-a-Service} (BaaS).\footfullcite{baas_definition}
...
Firebase zároveň využívá principy \textbf{serverless architektury}.\footfullcite{firebase_serverless}
...
Zároveň je to řešení, které je vhodné pro malé vývojové týmy, protože umožňuje rychlejší implementaci díky předpřipraveným službám.\footfullcite{firebase_benefits}
S~ohledem na realizaci aplikace jednotlivcem a rozsah bakalářské práce se jedná o~vhodné řešení.
Další výhodou použití Firebase je jeho snadná integrace s~platformou Android a jazykem Kotlin, protože Firebase poskytuje oficiální SDK a knihovny pro tyto technologie.\footfullcite{firebase_android_kotlin_support}
...
Dokument je datový záznam, který obsahuje páry klíč-hodnota.\footfullcite{firestore_data_model}
...
Google Maps nabízí velmi rozsáhlou dokumentaci a snadnou integraci s~platformou Android a frameworkem Jetpack Compose.\footfullcite{google_maps_integration}
