...
\subsection{Backendové řešení}\label{subsec:backend-solution}
...
Pro realizaci backendové části aplikace bylo zvoleno řešení Firebase.

Zvolené řešení Firebase představuje plnohodnotné backendové řešení typu \textbf{Backend-as-a-Service} (BaaS)~\parencite{baas_definition}.
BaaS je model cloudové služby, který poskytuje vývojářům předpřipravené backendové služby.
...
Díky tomuto modelu nemusí vývojář řešit provozní aspekty backendu, jako je nasazení, škálovatelnost a údržba serveru.
V~případě, že je potřeba implementovat vlastní logiku na straně serveru, Firebase nabízí službu \textbf{Cloud Functions}, která umožňuje spouštět backendový kód formou serverless funkcí v~reakci na definované události.
...
To umožňuje případnou budoucí náhradu zvoleného backendového řešení jinou technologií, například vlastním serverovým backendem.
