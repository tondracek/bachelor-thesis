...
Omezením je však menší míra přizpůsobení mapového vzhledu a absence vestavěných nástrojů pro efektivní práci s~větším množstvím zobrazovaných prvků zároveň bez využití externích nástrojů.

Mapbox představuje populární alternativu ke službě Google Maps.
Poskytuje rovněž kvalitní dokumentaci a snadnou integraci s~platformou Android a navíc nabízí vyšší míru přizpůsobitelnosti mapových stylů a lepší výkon při zobrazení většího množství značek na mapě~\parencite{mapbox_benefits}.
