...
Firebase poskytuje jako databázové řešení dokumentově orientovanou NoSQL databázi Firestore.\footfullcite{firebase_firestore}
Tento typ databáze ukládá data ve formě dokumentů seskupených do kolekcí.

Dokument je jednoduchý datový záznam, který obsahuje páry klíč-hodnota.
...
%TODO: dokončit
% proč je vhodná pro moji aplikaci + zdroj
