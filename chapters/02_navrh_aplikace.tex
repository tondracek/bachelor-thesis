...
%Celkový návrh class diagramu odděluje entity s~vlastní identitou od hodnotových objektů, které jsou používány jako jejich součásti.
%
%Tím je dosaženo přehledné struktury doménového modelu, která odpovídá požadavkům aplikace a zároveň umožňuje její další rozšiřování.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\textwidth]{res/ui/map_view}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\textwidth]{res/ui/map_view_shop_detail}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\textwidth]{res/ui/list_view}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\textwidth]{res/ui/shop_detail}
