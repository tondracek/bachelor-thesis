...
Mobilní zařízení tak přirozeně podporuje jak různá použití aplikace, tak i následnou komunikaci s~producenty.

Desktopová aplikace tedy přirozeně neodpovídá charakteru navrhované aplikace.
...
Webová aplikace by sice zajistila širší dostupnost napříč zařízeními, avšak v~prostředí mobilních zařízení by ve srovnání s~nativní mobilní aplikací poskytovala méně vhodný uživatelský zážitek, jak z~hlediska výkonu a odezvy, tak i z~hlediska přístupu k~nativním funkcím zařízení~\parencite{native_vs_web_app}.

Další možností by bylo využití multiplatformních frameworků, jako jsou Flutter nebo React Native.
...
S~ohledem na zaměření práce výhradně na platformu Android, rozsah bakalářské práce i vyjmenované výhody bylo zvoleno nativní řešení pro Android.
V~České republice je navíc právě Android nejrozšířenějším operačním systémem pro mobilní zařízení, a proto je tato platforma vhodnou volbou pro tuto aplikaci~\parencite{android_market_share_cz}.
