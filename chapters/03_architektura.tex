...
Je to doporučený vzor pro vývoj nativních Android aplikací, který je podporován samotným Android frameworkem a prosazován společností Google, která stojí za vývojem platformy Android~\parencite{android_recommended_architecture}.
...
Tomuto přístupu se říká \textbf{jednosměrný tok dat} (unidirectional data flow)~\parencite{android_recommended_architecture} a přispívá k~lepší předvídatelnosti a stabilitě aplikace.
...
ViewModely v~této aplikaci nevykonávají žádné přímé akce nad uživatelským rozhraním, ale vystavují takzvané \textbf{vedlejší efekty} (side effects)~\parencite{android_side_effect}.
