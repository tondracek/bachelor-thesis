...
Naopak špatně navržená architektura může vést k~problémům, jako je těžko udržovatelný kód, složitá rozšiřitelnost, náročné zjišťování chyb a pomalejší vývoj.
...
Kromě toho složka ui obsahuje také podsložky \textbf{ui/common}, která obsahuje sdílené prvky uživatelského rozhraní, a \textbf{ui/core}, která obsahuje základní komponenty a centrální logiku pro práci s~uživatelským rozhraním (navigace a navigační lišta, vyvolávání vyskakovacích oken, informační lišty apod.).
