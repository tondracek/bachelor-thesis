...
Alternativami k~vzoru architektonickému MVVM jsou například Model-View-Presenter (MVP) nebo Model-View-Intent (MVI)~\parencite{mvp_mvvm_mvi, android_mvi}.
U~vzoru MVP Presenter přímo manipuluje s~uživatelským rozhraním, což zcela neodpovídá deklarativnímu přístupu frameworku Jetpack Compose, který je využíván v~této aplikaci.
MVI je velmi dobře kompatibilní s~deklarativním přístupem frameworku Jetpack Compose, ale je výrazně komplexnější než architektura MVVM\@.
