...
Jako základní architektonický vzor byla zvolena architektura Model-View-ViewModel (MVVM)~\parencite{mvvm}.
...
Projekt je strukturován podle funkčních celků (feature-based struktura), kdy jednotlivé části aplikace odpovídají konkrétním oblastem domény nebo uživatelské funkcionality~\parencite{android_modularization_patterns}.
...
Jedním ze základních principů architektury aplikace je oddělení doménové a datové vrstvy~\parencite{domain_data_layer_separation}.
