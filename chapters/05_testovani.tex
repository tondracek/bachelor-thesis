...
V průběhu vývoje byly využity různé přístupy k testování, od automatizovaných jednotkových testů přes manuální testování až po možnost sledování chyb v reálném provozu pomocí nástrojů třetích stran.
